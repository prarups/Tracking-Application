...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 dark:from-blue-950/90 dark:via-indigo-950/90 dark:to-purple-950/90 border border-blue-400/30 dark:border-blue-500/20 p-6 sm:p-8 shadow-xl backdrop-blur-xl transition-all">
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 dark:bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
        
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2.5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 dark:bg-blue-500/20 border border-white/30 dark:border-blue-400/30 text-white dark:text-blue-300 text-xs font-bold backdrop-blur-md shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-amber-300" /> Next-Gen Enterprise Workspace
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              Welcome back, <span className="text-amber-300 font-black drop-shadow-sm">{user?.first_name || user?.username}</span>!
            </h1>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card p-5 rounded-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Total Tickets</span>
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-glow-blue">
        ...
        <div className="glass-card p-5 rounded-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Active / Open</span>
          ...
          <div className="mt-3 flex items-baseline justify-between">
            <span className="text-3xl font-black text-amber-600 dark:text-amber-400">{openCount}</span>
            <span className="text-[11px] text-slate-600 dark:text-slate-400">In Pipeline</span>
          </div>
        </div>

        <div className="glass-card p-5 rounded-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Resolved / Closed</span>
          ...
          <div className="mt-3 flex items-baseline justify-between">
            <span className="text-3xl font-black text-emerald-600 dark:text-emerald-400">{closedCount}</span>
            <span className="text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold">98.4% SLA Pass</span>
          </div>
        </div>

        <div className="glass-card p-5 rounded-2xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Urgent / Critical</span>
            <div className="w-10 h-10 rounded-xl bg-red-500/10 border border-red-500/30 flex items-center justify-center text-red-600 dark:text-red-400">
              <ShieldAlert className="w-5 h-5" />
            </div>
          </div>
          <div className="mt-3 flex items-baseline justify-between">
            <span className="text-3xl font-black text-red-600 dark:text-red-400">{urgentCount}</span>
            <span className="text-[11px] text-red-600 dark:text-red-400 font-semibold">Immediate Priority</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Ticket Status Breakdown
            </h3>
            <span className="text-[10px] font-mono bg-blue-500/20 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded border border-blue-500/30">
              Live
            </span>
          </div>
          <div className="h-60">
        ...
        <div className="glass-panel p-6 rounded-2xl shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <Zap className="w-4 h-4 text-amber-500 dark:text-amber-400" /> Resolution Velocity Trend
            </h3>
            <span className="text-[10px] font-mono bg-amber-500/20 text-amber-700 dark:text-amber-300 px-2 py-0.5 rounded border border-amber-500/30">
              Monthly
            </span>
          </div>
          <div className="h-60">
        ...
        <div className="glass-panel p-6 rounded-2xl shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <AlertTriangle className="w-4 h-4 text-purple-600 dark:text-purple-400" /> Priority Spread
            </h3>
          </div>
